"""UK/Australian-to-US spelling pairs vendored from localspelling 0.94.

Source: https://github.com/fastdatascience/localspelling
Package metadata identifies the source as MIT licensed. The scorer uses these
pairs only for lexical scoring; original references and predictions are never
rewritten.
"""
